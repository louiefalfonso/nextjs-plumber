          ...
          <div className="col-xxl-4 col-lg-4">
            <aside className="sidebar-area">
              ...
              <div className="widget widget_categories  ">
                ...
                <ul>
                  <li>
                    <a href="blog.html">Plumbing Service</a>
                    <span>(8)</span>
                  </li>
                  <li>
                    <a href="blog.html">Air Conditionerg</a>
                    <span>(10)</span>
                  </li>
                  <li>
                    <a href="blog.html">Carpenter</a>
                    <span>(12)</span>
                  </li>
                  <li>
                    <a href="blog.html">Electrician</a>
                    <span>(6)</span>
                  </li>
                  <li>
                    <a href="blog.html">Handyman</a>
                    <span>(8)</span>
                  </li>
                  <li>
                    <a href="blog.html">Roofing</a>
                    <span>(11)</span>
                  </li>
                </ul>
              </div>
