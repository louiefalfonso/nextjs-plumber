            ...
            <div className="row gy-30">
                <div className="col-md-6 col-xl-4">
                    ...
                    <div className="service-block_icon">
                        <div className="icon">
                        <img src="img/icon/service_block_1.svg" alt="Icon" />
                        </div>
                    </div>
                ...
                <div className="col-md-6 col-xl-4">
                    ...
                    <div className="service-block_icon">
                        <div className="icon">
                        <img src="img/icon/service_block_2.svg" alt="Icon" />
                        </div>
                    </div>
                    <div className="service-block_img">
                ...
                <div className="col-md-6 col-xl-4">
                    ...
                    <div className="service-block_icon">
                        <div className="icon">
                        <img src="img/icon/service_block_3.svg" alt="Icon" />
                        </div>
                    </div>
                    <div className="service-block_img">
                ...
                <div className="col-md-6 col-xl-4">
                    ...
                    <div className="service-block_icon">
                        <div className="icon">
                        <img src="img/icon/service_block_4.svg" alt="Icon" />
                        </div>
                    </div>
                    <div className="service-block_img">
                ...
                <div className="col-md-6 col-xl-4">
                    ...
                    <div className="service-block_icon">
                        <div className="icon">
                        <img src="img/icon/service_block_5.svg" alt="Icon" />
                        </div>
                    </div>
                    <div className="service-block_img">
                ...
                <div className="col-md-6 col-xl-4">
                    ...
                    <div className="service-block_icon">
                        <div className="icon">
                        <img src="img/icon/service_block_6.svg" alt="Icon" />
                        </div>
                    </div>
                    <div className="service-block_img">
